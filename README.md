...
But the stakes are very much the same. The stakes are humanity itself. And the task of this paradigm delivery is scary in a very similar way.
  ...
  <br>_Computation with this model must not require permission from any authority, centralised entity or agency. Execution cannot be blocked by any vendor, platform, or certificate authority. No gatekeeping or withholding of certificates by any authority with the intention to impose control is allowed. The right to evaluate the level of trust must remain with each individual user._  
